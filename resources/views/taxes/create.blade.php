        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('vat-groups.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('rate') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" step="0.01" min="0" max="1" name="rate" id="rate" class="form-control form-control-alternative{{ $errors->has('rate') ? ' is-invalid' : '' }}" placeholder="Rate" value="{{ old('rate') }}" required autofocus>
