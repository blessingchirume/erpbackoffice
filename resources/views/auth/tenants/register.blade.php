    ...
    <div class="row">
        <div class="col-md-7 ml-auto mr-auto">
            <div class="card card-register card-white">
                ...
                <form class="form" method="post" action="{{ route('tenant.register') }}">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="input-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Company Name" value="{{ old('name') }}">
                        ...
                        <div class="input-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            ...
                            <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Contact Email" value="{{ old('email') }}">
                        ...
                        <div class="input-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="business_type" class="form-control {{ $errors->has('business_type') ? ' is-invalid' : '' }}" placeholder="Category" value="{{ old('business_type') }}">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-round btn-lg">Creat Account</button>
                    </div>
                </form>
            </div>
        </div>
