@extends('layouts.app', ['page' => 'New Provider', 'pageSlug' => 'provider', 'section' => 'currencies'])
@section('content')
                        ...
                        <form method="post" action="{{ route('currencies.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('rate') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" step="0.1" min="0" name="rate" id="rate" class="form-control form-control-alternative{{ $errors->has('rate') ? ' is-invalid' : '' }}" placeholder="Rate" value="{{ old('rate') }}" required autofocus>
